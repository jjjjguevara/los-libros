 ...
 * between the Obsidian vault and Amnesia Server.
 */
import { App, TFile } from 'obsidian';
import { AmnesiaClient, ReadingProgress, ServerHighlight } from './amnesia-client';
...
export class ServerSyncService {
  ...
  constructor(app: App, serverUrl: string) {
    this.app = app;
    this.client = new AmnesiaClient(app, serverUrl);
  }
  ...
  /**
   * Get the Amnesia client for direct OPDS access
   */
  getClient(): AmnesiaClient {
    return this.client;
  }
