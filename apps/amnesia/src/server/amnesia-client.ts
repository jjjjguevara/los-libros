/**
 * Amnesia Server Client
 *
 * Extends OPDS client with reading progress and highlights sync.
 * Used for bidirectional sync with the Amnesia Server.
 */
...
/**
 * Amnesia Server client with progress and highlights sync
 */
export class AmnesiaClient extends OPDSClient {
