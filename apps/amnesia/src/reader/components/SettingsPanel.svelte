...
{#if visible}
  ...
  <div class="graph-controls amnesia-settings" on:click|stopPropagation data-ignore-swipe="true">
...
<style>
  ...
  .amnesia-color-btn:hover {
    transform: scale(1.1);
  }

  .amnesia-color-btn.is-active {
