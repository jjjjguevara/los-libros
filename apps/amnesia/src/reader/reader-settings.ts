...
export const THEME_CSS_VARS: Record<ThemePreset, { bg: string; text: string }> = {
  ...
  light: {
    bg: '--amnesia-reader-bg-light',
    text: '--amnesia-reader-text-light',
  },
  dark: {
    bg: '--amnesia-reader-bg-dark',
    text: '--amnesia-reader-text-dark',
  },
  sepia: {
    bg: '--amnesia-reader-bg-sepia',
    text: '--amnesia-reader-text-sepia',
  },
  night: {
    bg: '--amnesia-reader-bg-night',
    text: '--amnesia-reader-text-night',
  },
  paper: {
    bg: '--amnesia-reader-bg-paper',
    text: '--amnesia-reader-text-paper',
  },
  forest: {
    bg: '--amnesia-reader-bg-forest',
    text: '--amnesia-reader-text-forest',
  },
};
