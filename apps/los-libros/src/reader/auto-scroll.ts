...
export class AutoScroller {
  ...
  private updateScrollableElements(): void {
    ...
    const readerContainer = document.querySelector('.los-libros-reader-content') as HTMLElement | null;
    ...
    const readerView = document.querySelector('.los-libros-reader-view') as HTMLElement | null;
    if (readerView) {
    ...
    const iframe = document.querySelector('.los-libros-reader-view iframe') as HTMLIFrameElement | null;
