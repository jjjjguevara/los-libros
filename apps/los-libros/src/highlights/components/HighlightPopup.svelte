...
<style>
  .highlight-popup {
    ...
    background: var(--los-libros-popup-bg, var(--background-primary));
    border: 1px solid var(--los-libros-popup-border, var(--background-modifier-border));
    border-radius: var(--los-libros-popup-radius, 8px);
